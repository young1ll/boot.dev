# description: MacOS 웹 개발 전용 패키지: asdf 기반
...
# Network -------------------------------------------------------------------- #
brew "nmap" # 네트워크 탐색 및 보안 감사
brew "netcat" # 네트워크 연결 검사 | https://www.varonis.com/blog/netcat-commands
brew "mtr" # 네트워크 경로 추적 및 진단
brew "nikto" # 웹 취약점 스캐너
brew "httpie" # CLI HTTP 클라이언트 | https://github.com/httpie/cli

brew 'speedtest-cli' # CLI 네트워크 테스트
brew "k6" # Load Testing https://github.com/grafana/k6
cask "k6-studio" # Load Testing App
...
# WebServer ------------------------------------------------------------------ #
brew "nginx" # HTTP 서버
brew "dnsmasq" # 경량 로컬 DNS 서버

# DB Client ------------------------------------------------------------------ #
cask "tableplus" # TablePlus DB Client
...
# FONTS ---------------------------------------------------------------------- #
cask "font-hack"
cask "font-meslo-lg-nerd-font" # p10k mono font
cask "font-d2coding" # naver mono font
